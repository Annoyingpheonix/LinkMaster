...
import { Mail, Lock, ArrowRight, CheckCircle, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-blue-600 to-indigo-700 text-white text-center">
          ...
          <h1 className="text-2xl font-bold">LinkMaster AI</h1>
          <p className="text-blue-100 text-sm mt-2">Sign in to your growth operating system</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button 
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors text-sm font-medium text-slate-700 disabled:opacity-50"
            >
              <GoogleIcon />
              <span>Google</span>
            </button>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
